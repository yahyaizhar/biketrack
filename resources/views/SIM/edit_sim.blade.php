                ...
                <div class="kt-portlet">
                    ...
                    @include('admin.includes.message')
                        <div class="kt-portlet__body">
                                ...
                                <input disabled type="text" class="form-control @if($errors->has('sim_number')) invalid-field @endif" name="sim_number" placeholder="Enter Sim Number" value="{{$sim->sim_number}}">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select disabled class="form-control @if($errors->has('sim_company')) invalid-field @endif kt-select2" id="kt_select2_3" name="sim_company" placeholder="Enter Sim Company" >
                                        ...
                                        <div class="form-group">
                                                <label>Status:</label>
                                                <div>
                                                    <input disabled data-switch="true" name="status" id="status" type="checkbox" {!! $sim->status ==  1 ? 'checked' : '' !!} data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="brand">
                                                </div>
                                            </div>
                        </div>
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions kt-form__actions--right">
                            <a href="{{route('Sim.edit_sim',$sim->id)}}"><button class="btn btn-primary">Edit</button></a> 
                            </div>
                        </div>
                    </div>
        </div> 
