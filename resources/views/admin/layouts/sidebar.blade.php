                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu @if(strpos(Request::url(), "mobile") !== false) kt-menu__item--active kt-menu__item--open @endif " aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                ...
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item @if(strpos(Request::url(), "/mobile/sellers/view") !== false) kt-menu__item--active @endif  " aria-haspopup="true"><a href="{{ route('mobile.sellers_view') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">View Sellers</span></a></li>
                                        <li class="kt-menu__item @if(strpos(Request::url(), "/mobile/accessory/view") !== false) kt-menu__item--active @endif  " aria-haspopup="true"><a href="{{ route('mobile.accessory_view') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">View Accessories</span></a></li>
                                     </ul> 
                                </div>
                            </li>
