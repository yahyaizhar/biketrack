               ...
               @endif
                ...
                <li class="kt-menu__item  kt-menu__item--submenu @if(strpos(Request::url(), "admin/active_riders") !== false || strpos(Request::url(), "admin/rider/complete/detail/view") !== false || strpos(Request::url(), "admin/Salary/accounts/rider/account") !== false || strpos(Request::url(), "admin/Salary/accounts/rider/expense") !== false) kt-menu__item--active kt-menu__item--open @endif @if(strpos(Request::url(), "admin/rider") !== false) kt-menu__item--active kt-menu__item--open @endif " aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            @php $is_in_array = Arr::first($users, function ($item) { return $item['action_name']=='admin.accounts.rider_account';   }); @endphp
                            @if($is_in_array || $is_admin)
                            <li class="kt-menu__item @if(strpos(Request::url(), "/rider/manage-salaryslips") !== false && strpos(Request::url(), "admin/rider/manage-salaryslips") != false) kt-menu__item--active @endif  " aria-haspopup="true">
                                <a route_status="{{$is_in_array['action_name']}}" href="{{ route('admin.accounts.manage_salaryslips') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Manage Salary Slips</span>
                                </a>
                            </li>
                            @endif
                            ...
                            @php $is_in_array = Arr::first($users, function ($item) { return $item['action_name']=='admin.view_deleted_data';   }); @endphp
                            @if($is_in_array || $is_admin)
                            <li class="kt-menu__item @if(strpos(Request::url(), "/rider/deleted_data/view") !== false) kt-menu__item--active @endif  " aria-haspopup="true">
                                <a route_status="{{$is_in_array['action_name']}}" href="{{ route('admin.view_deleted_data') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Deleted Row Status</span>
                                </a>
                            </li>
                            @endif
                ...
                <i class="fa fa-hotel"></i>    
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            @if($is_in_array || $is_admin)
                            <li class="kt-menu__item @if(strpos(Request::url(), "active/client") !== false && strpos(Request::url(), "admin/clients/create") == false && strpos(Request::url(), "client_income") == false) kt-menu__item--active @endif  " aria-haspopup="true">
                                <a href="{{ route('admin.all_clients_salary_sheet_export') }}" class="kt-menu__link ">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                    <span class="kt-menu__link-text">View salary sheet</span>
                                </a>
                            </li>
                            @endif
                        ...
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item kt-menu__item--submenu @if(strpos(Request::url(), "/employee") !== false) kt-menu__item--active kt-menu__item--open @endif "  aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                    ...
                                    <span class="kt-menu__link-text">Employee Accounts</span>
                                    <i class="kt-menu__ver-arrow la la-angle-right"></i>
                                </a>
                                <div class="kt-menu__submenu " kt-hidden-height="160" @if(strpos(Request::url(), "/employee") === false)style="display: none; overflow: hidden;"@endif><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text"></span></span></li>
                                        @php $is_in_array = Arr::first($users, function ($item) { return $item['action_name']=='employee.viewCompanyEmployeeAccount';   }); @endphp
                                        @if($is_in_array || $is_admin)
                                        <li class="kt-menu__item @if(strpos(Request::url(), "/employee/company_account") !== false) kt-menu__item--active @endif  " aria-haspopup="true">
                                            <a href="{{ route('employee.viewCompanyEmployeeAccount') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Company-Employee Account</span>
                                            </a>
                                        </li>
                                        @endif

                                        @php $is_in_array = Arr::first($users, function ($item) { return $item['action_name']=='Employee.viewEmployee';   }); @endphp
                                        @if($is_in_array || $is_admin)
                                        <li class="kt-menu__item @if(strpos(Request::url(), "/show/employee") !== false) kt-menu__item--active @endif  " aria-haspopup="true">
                                            <a href="{{ route('Employee.viewEmployee') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">View Employee</span>
                                            </a>
                                        </li>
                                        @endif

                                        @php $is_in_array = Arr::first($users, function ($item) { return $item['action_name']=='Employee.viewActiveEmployee';   }); @endphp
                                        @if($is_in_array || $is_admin)
                                        <li class="kt-menu__item @if(strpos(Request::url(), "/show/active_employee") !== false) kt-menu__item--active @endif  " aria-haspopup="true">
                                            <a href="{{ route('Employee.viewActiveEmployee') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">View Active Employee</span>
                                            </a>
                                        </li>
                                        @endif
                ...
                <li class="kt-menu__item  kt-menu__item--submenu @if(strpos(Request::url(), "tax") !== false || strpos(Request::url(), "invoice") !== false) kt-menu__item--active kt-menu__item--open @endif " aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu @if(strpos(Request::url(), "employee") !== false) kt-menu__item--active kt-menu__item--open @endif " aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                        ...
                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                            <ul class="kt-menu__subnav">
                                @php $is_in_array = Arr::first($users, function ($item) { return $item['action_name']=='employee.viewEmployeeAccount';   }); @endphp
                                @if($is_in_array || $is_admin)
                                <li class="kt-menu__item @if(strpos(Request::url(), "/employee/employee_account") !== false) kt-menu__item--active @endif  " aria-haspopup="true">
                                    <a href="{{ route('employee.viewEmployeeAccount') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Account</span>
                                    </a>
                                </li>
                                @endif
                            </ul> 
