...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            ...
            <!--begin: Datatable -->
            <table class="table table-striped- table-hover table-checkable table-condensed" id="fuelExpense-table">
                <thead>
                    <tr>
                        {{-- <th>
...
$(function() {
    expense_table = $('#fuelExpense-table').DataTable({
        ...
        ajax: "{!! route('admin.accounts.ajax_fuelExpense') !!}",
        columns: [
...
{
    var url = "{{ url('admin/accounts/fuel_expense/delete') }}"+ "/" + id  ;
    console.log(url,true);
    sendDeleteRequest(url, false, null, expense_table);
}
function updateStatus(id)
{
    var url = "{{ url('admin/accounts/fuel_expense') }}" + "/" + id +"/updatestatus";
    console.log(url,true);
    swal.fire({
        title: 'Are you sure?',
