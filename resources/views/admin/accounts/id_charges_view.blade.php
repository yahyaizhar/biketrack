...
$(function() {
    charges_table = $('#charges-table').DataTable({
        ...
        ajax: "{!! route('admin.accounts.id_charges_view_data') !!}",
        columns: [
...
{
    var url = "{{ url('admin/accounts/id-charges') }}"+ "/" + id ;
    console.log(url,true);
    sendDeleteRequest(url, false, null, charges_table);
}
function updateStatus(id)
{
    var url = "{{ url('admin/accounts/id-charges') }}" + "/" + id + "/updateStatus";
    console.log(url,true);
    swal.fire({
        title: 'Are you sure?',
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    charges_table.ajax.reload(null, false);
                },
