            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        &nbsp;
                        <a href="{{ route('admin.accounts.maintenance_index') }}" class="btn btn-brand btn-elevate btn-icon-sm">
...
$(function() {
    maintenance_table = $('#charges-table').DataTable({
        ...
        ajax: "{!! route('admin.accounts.maintenance_view_data') !!}",
        columns: [
...
{
    var url = "{{ url('admin/accounts/maintenance') }}"+ "/" + id ;
    console.log(url,true);
    sendDeleteRequest(url, false, null, maintenance_table);
}
function updateStatus(id)
{
    var url = "{{ url('admin/accounts/maintenance') }}" + "/" + id + "/updateStatus";
    console.log(url,true);
    swal.fire({
        title: 'Are you sure?',
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    maintenance_table.ajax.reload(null, false);
                },
