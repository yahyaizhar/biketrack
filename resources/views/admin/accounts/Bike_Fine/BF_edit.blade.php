                    ...
                    @include('admin.includes.message')
                        ...
                        <div class="form-group">
                            ...
                            <select disabled class="form-control bk-select2 kt-select2-general" name="rider_id" >
                                ...
                                <option value="{{ $rider->id }}" @if ($bf->rider_id==$rider->id) selected @endif>
                                    {{ $rider->name }}
                                </option>     
                                @endforeach 
                            </select>
                        ...
                        <div class="form-group">
                                ...
                                <select disabled class="form-control kt-select2-general" name="bike_id" >
                                    ...
                                    <option value="{{ $bike->id }}" @if ($bf->bike_id==$bike->id) selected @endif>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <textarea disabled type="text" class="form-control @if($errors->has('description')) invalid-field @endif" rows="5" cols="12" name="description" placeholder="Enter Description" value="">{{$bf->description}}</textarea>
                        ...
                        <div class="kt-portlet__foot">
                            ...
                            <a href="{{url('admin/accounts/BF/edit',$bf->id)}}"><button class="btn btn-primary">Edit</button></a>
            ...
            <!--begin::Portlet-->
                <div class="kt-portlet">
                    ...
                    <form class="kt-form" id="bike_fine" action="{{ route('admin.BF_update',$bf->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="form-group">
                            <label>Description:</label> 
                            <textarea required type="text" class="form-control @if($errors->has('description')) invalid-field @endif" rows="5" cols="12" name="description" placeholder="Enter Description" value="">{{$bf->description}}</textarea>
                            @if ($errors->has('description'))
                                <span class="invalid-response" role="alert">
                                    <strong>
                                        {{$errors->first('description')}}
