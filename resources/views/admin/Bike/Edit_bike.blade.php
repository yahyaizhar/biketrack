                ...
                <form class="kt-form" action="{{ route('Bike.bike_update', $bike->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    <label>Owner:</label>
                                    <select disabled class="form-control bk-select2 @if($errors->has('owner')) invalid-field @endif kt-select2" id="kt_select2_3" name="owner" placeholder="Enter Owner" value="{{ old('owner') }}">
                                ...
                                <div class="all_details_kr">
                                    <div class="row rental_bike_details">
                                        ...
                                        <input disabled type="text" class="form-control" name="rental_company" placeholder="Enter Rental Company Name" value="{{$bike->rental_company}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Contract Start Date:</label>
                                        <input disabled type="text" id="datepicker_con_1" autocomplete="off" class="form-control" name="contract_start" placeholder="Enter Contract Start Date" value="{{$bike->contract_start}}">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Contract End Date:</label>
                                            <input disabled type="text" id="datepicker_con_2" autocomplete="off" class="form-control" name="contract_end" placeholder="Enter Contract End Date" value="{{$bike->contract_end}}">
                                        </div>
                                    </div>
                                    <div class="form-group monthly_rent"> 
                                        <label>Monthly Rent:</label>
                                        <input disabled type="text" class="form-control" name="rent_amount" placeholder="Ente Amount of Rent" value="{{$bike->rent_amount}}">
                                    </div>
                                    <div class="form-group purchase_price"> 
                                        <label>Purchase price:</label>
                                        <input disabled type="text" class="form-control" id="purchase_price" name="amount" placeholder="Ente Bike Price" value="{{$bike->amount}}">
                                    </div>
                                    <div class="row rider_self_detail">
                                        <div class="col-md-9">
                                            <label>Select Rider:</label>
                                            <select disabled class="form-control kt-select2 bk-select2" id="rider_id" name="rider_id" >
                                        ...
                                        <div class="form-group col-md-3"> 
                                            ...
                                            <input disabled type="text" class="form-control" id="bike_allowns" name="bike_allowns" placeholder="Ente Bike Allowns" value="{{$bike->bike_allowns}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" required class="form-control @if($errors->has('bike_number')) invalid-field @endif" name="bike_number" placeholder="Enter Bike Number (etc K-3102)" value="{{ $bike->bike_number }}">
                        ...
                        <div class="form-group">
                                ...
                                <select disabled class="form-control  @if($errors->has('brand')) invalid-field @endif kt-select2" id="kt_select2_3" name="brand" placeholder="Enter Brand (etc Honda)" >
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text"  class="form-control " name="chassis_number" placeholder="Enter Chassis Number" value="{{ $bike->chassis_number }}">
                                <span class="form-text text-muted">Enter Your Chassis Number.</span>
                            </div> 
                            <div class="form-group">
                                <label>Insurance Company:</label>
                                <select disabled class="form-control bk-select2 kt-select2" id="insurance_co" name="insurance_co" placeholder="Enter Insurance Company">
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" data-month="{{Carbon\Carbon::parse($bike->issue_date)->format('M d, Y')}}"  readonly class="month_picker form-control" name="issue_date" placeholder="Enter Issue Date">
                                <span class="form-text text-muted">Please enter Issue Bike Date</span>
                            </div>
                            <div class="form-group">
                                <label>Insurance Expiry Date:</label>
                                <input disabled type="text" data-month="{{Carbon\Carbon::parse($bike->expiry_date)->format('M d, Y')}}"  readonly class="month_picker form-control" name="expiry_date" placeholder="Enter Expiry Date">
                                <span class="form-text text-muted">Please enter Bike Expiry Date</span>
                            </div>
                      
                        <div class="form-group">
                                <label>Mulkiya Number:</label>
                                <input disabled type="text"  class="form-control" name="mulkiya_number" placeholder="Enter Mulkiya Nnumber" value="{{ $bike->mulkiya_number }}">
                               
                            </div> 
                            <div class="form-group">
                                    <label>Mulkiya Expiry:</label>
                                    <input disabled type="text" id="datepicker" autocomplete="off" class="form-control " name="mulkiya_expiry" placeholder="Enter Mulkiya Expiry" value="{{ $bike->mulkiya_expiry}}">
                        ...
                        <div class="form-group">
                            <label>Status:</label>
                            <div>
                                <input disabled data-switch="true" name="status" id="status" type="checkbox" {!! $bike->status ==  1 ? 'checked' : '' !!} data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="brand">
                            </div>
                        </div>
                        
                    </div>
                    <div class="kt-portlet__foot">
                        <div class="kt-form__actions kt-form__actions--right" style="text-align: left;">
                            {{-- <button type="submit" class="btn btn-primary">Submit</button> --}}
                             <a href="{{ route('Bike.edit_bike',$bike->id) }}" class="kt-font-bold btn btn-primary">Edit</a>
                        </div>
                    </div>
                </form>
