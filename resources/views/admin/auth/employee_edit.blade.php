...
<form class="kt-form" action="{{ route('Employee.update_employee',$edit_employee->id) }}" method="POST"
    ...
    <div class="kt-portlet__body">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="form-group">
                    <label>Name:</label>
                    <input type="text" class="form-control @if($errors->has('name')) invalid-field @endif" name="name"
                        placeholder="Enter Your Name" required autofocus value="{{ $edit_employee->name }}">
                    @if ($errors->has('name'))
                ...
                <div class="form-group">
                    <label>Email:</label>
                    <input type="text" class="form-control @if($errors->has('email')) invalid-field @endif" name="email"
                        placeholder="Enter Your Email" required value="{{ $edit_employee->email }}">
                    @if ($errors->has('email'))
                    <span class="invalid-feedback" role="alert">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <img class="profile-logo img img-thumbnail" src="{{ asset(Storage::url($edit_employee->logo)) }}"
                    alt="image">
                @else
            ...
            <div class="form-group">
                ...
                <select class="form-control bk-select2 kt-select2-general" name="s_emp_id">
                    ...
                    @foreach ($employees as $employee)
                        @unless ($employee->id==$edit_employee->id)
        ...
        <div id="password-fields" style="display:none;">
            <div class="form-group">
                ...
                <input type="password" class="form-control @if($errors->has('passsword')) invalid-field @endif"
                ...
                <div class="form-group">
                    ...
                    <ul class="nav">
                        <li class="nav-item" style="width:25%;font-weight:700;">
                            <label class="kt-checkbox" style="font-weight:700;"> <input name="checktype"
                                    type="checkbox"> View <span></span> </label>
                                    ...
                                    <div class="route_data">
                                        ...
                                        <label class="kt-checkbox" style="display:none;">
                                            <input @foreach($users as $user)
                                                @if($user['action_name']==$wroute->route_name) checked @endif
                                            @endforeach id="action_name" name="action_name[]" type="checkbox"
                                            value="{{$wroute->route_name}}" routelabel="{{$wroute->label}}">
                                            {{$wroute->label}}
                                            <span></span>
                                        </label>
                                        @else
                        ...
                        <li class="nav-item" style="width:25%;font-weight:700;">
                            <label class="kt-checkbox" style="font-weight:700;"> <input name="checktype"
                                    type="checkbox"> Add <span></span> </label>
                            <ul style=" padding: 0px; list-style-type: none; ">
                                <li>
                                    <div class="route_data">
                                        @foreach($webroutes as $wroute)
                        ...
                        <li class="nav-item" style="width:25%;font-weight:700;">
                            <label class="kt-checkbox" style="font-weight:700;"> <input name="checktype"
                                    type="checkbox"> Edit/Update/Delete <span></span> </label>
                            <ul style=" padding: 0px; list-style-type: none; ">
                                <li>
                                    <div class="route_data">
                                        @foreach($webroutes as $wroute)
                        ...
                        <li class="nav-item" style="width:25%;font-weight:700;">
                            <label class="kt-checkbox" style="font-weight:700;"> <input name="checktype"
                                    type="checkbox"> Others <span></span> </label>
                            <ul style=" padding: 0px; list-style-type: none; ">
                                <li>
                                    <div class="route_data">
                                        @foreach($webroutes as $wroute)
