                    ...
                    @include('admin.includes.message')
                        <div class="kt-portlet__body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label>Salary:</label>
                                        <input disabled type="text" class="form-control @if($errors->has('salary')) invalid-field @endif" name="salary" placeholder="salary" value="{{ $developer->salary }}">
                                    ...
                                    <div class="form-group">
                                        <label>Paid By:</label>
                                        <input disabled type="text" class="form-control @if($errors->has('paid_by')) invalid-field @endif" name="paid_by" placeholder="Paid By" value="{{ $developer->paid_by }}">
                            ...
                            <div class="form-group">
                                <label>Status:</label>
                                <div>
                                    <input disabled data-switch="true" name="status" id="status" type="checkbox" {!! $developer->status ==  1 ? 'checked' : '' !!} data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="brand">
                                </div>
                            </div>
                        </div>
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions kt-form__actions--right">
                            <a href="{{route('account.edit_developer',$developer->id)}}"> <button class="btn btn-primary">Edit</button></a>
                            </div>
                        </div>
                </div>
        </div>
