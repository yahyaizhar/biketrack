                    ...
                    @include('admin.includes.message')
                        <div class="kt-portlet__body">
                            <div class="form-group">
                                <label>Client:</label>
                                <select disabled class="form-control kt-select2-general" name="client_id" >
                            ...
                            <div class="form-group">
                                    <label>Rider:</label>
                                    <select disabled class="form-control kt-select2-general" name="rider_id" data-value="{{ $edit_client_income->rider_id }}">
                                    @php
                            ...
                            <div class="form-group">
                                    <label>Month:</label>
                                    <input disabled type="text" data-month="{{Carbon\Carbon::parse($edit_client_income->month)->format('M Y')}}" required readonly class="month_picker form-control @if($errors->has('month')) invalid-field @endif" name="month" placeholder="Enter Month" >
                                    @if ($errors->has('month'))
                            ...
                            <div class="form-group">
                                <label>Amount:</label>
                            <input disabled type="number" class="form-control @if($errors->has('amount')) invalid-field @endif" name="amount" placeholder="Enter Amount" value="{{ $edit_client_income->amount }}">
                            ...
                            <div class="form-group">
                                <label>Status:</label>
                                <div>
                                    <input disabled data-switch="true" name="status" id="status" type="checkbox" {!! $edit_client_income->status ==  1 ? 'checked' : '' !!} data-on-text="Enabled" data-handle-width="70" data-off-text="Disabled" data-on-color="brand">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="kt-portlet__foot">
                            ...
                            <a href="{{route('admin.client_income_edit',$edit_client_income->id)}}"><button class="btn btn-primary">Edit</button></a>
                            </div>
                        </div>
                </div>
        </div> 
