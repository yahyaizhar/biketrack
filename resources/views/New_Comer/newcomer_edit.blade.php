                    ...
                    @include('admin.includes.message')
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group">
                                <label>Name:</label>
                                <input disabled type="text" class="form-control @if($errors->has('name')) invalid-field @endif" name="name" placeholder="Enter your name" value="{{$newcomer->name}}" required>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                <label>Phone:</label>
                                <input disabled type="text" class="form-control @if($errors->has('phone_number')) invalid-field @endif" name="phone_number" placeholder="Enter phone number" value="{{$newcomer->phone_number}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control @if($errors->has('nationality')) invalid-field @endif" name="nationality" placeholder="Nationality" value="{{$newcomer->nationality}}" required> 
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control @if($errors->has('whatsapp_number')) invalid-field @endif" name="whatsapp_number" placeholder="Whatsapp Number" value="{{$newcomer->whatsapp_number}}" required> 
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" class="form-control @if($errors->has('education')) invalid-field @endif" name="education" placeholder="Education" value="{{$newcomer->education}}" required> 
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" id="licence_date" autocomplete="off" class="form-control @if($errors->has('licence_issue_date')) invalid-field @endif" name="licence_issue_date" placeholder="Licence Issue Date" value="{{$newcomer->licence_issue_date}}" required> 
                            ...
                            <input disabled type="text"  id="experience_input" autocomplete="off"class="form-control @if($errors->has('experience_input')) invalid-field @endif" name="experience_input" placeholder="Experiance Input" value="{{$newcomer->experience_input}}"><span class="form-text text-muted">Experience Input</span>   
                            </div>
                               <div class="form-group">
                               ...
                               <input disabled type="text"  id="passport_reason" autocomplete="off"class="form-control @if($errors->has('passport_reason')) invalid-field @endif" name="passport_reason" placeholder="Passport Reason" value="{{$newcomer->passport_status }}"><span class="form-text text-muted">Passport Reason</span>   
                           </div>
                           <div class="form-group">
                           ...
                           <div style="display: flex;margin-left:20px;"> <input disabled type="radio" class="form-control @if($errors->has('kingriders_interview')) invalid-field @endif" id="kingriders_interview" name="kingriders_interview" style="width: 2% !important;"@if ($newcomer->kingriders_interview==='pending') checked @endif value="pending"  required/><h6 style="margin-top:10px;margin-left:10px;">Pending</h6></div>   
                            ...
                            <div class="form-group" id="accpeted">
                                ...
                                <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12"><input disabled type="text"  id="datepicker1" autocomplete="off"class="form-control @if($errors->has('interview_date')) invalid-field @endif" name="interview_date" placeholder="Interview Date"  value="{{ $newcomer->interview_date}}"><span class="form-text text-muted">Interview Date</span> </div>
                                <div class="col-lg-4 col-md-4 col-sm-12"> <input disabled type="text" id="interview_by" class="form-control @if($errors->has('interview_By')) invalid-field @endif" name="interview_By" placeholder="Interview By"   value="{{ $newcomer->interview_By }}"><span class="form-text text-muted">Interview Conducted By</span> </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">  <input disabled type="text" id="datepicker2" autocomplete="off" class="form-control @if($errors->has('joining_date')) invalid-field @endif" name="joining_date" placeholder="Joining Date"   value="{{ $newcomer->joining_date }}"><span class="form-text text-muted">Interview Joining Date</span> </div>
                                </div>
                            </div>
                            <div class="form-group" id="rejected_why"> 
                                <label>If Rejected:</label>
                                <input readonly type="textarea" id="why_reject" class="form-control @if($errors->has('why_rejected')) invalid-field @endif" name="why_rejected" placeholder="Why Rejected" value="{{$newcomer->why_rejected}}">  
                            </div>
                            <div class="form-group">
                                <label>Overall Remarks:</label>
                                <input disabled type="text" class="form-control @if($errors->has('overall_remarks')) invalid-field @endif" name="overall_remarks" placeholder="Overall Remarks" value="{{$newcomer->overall_remarks}}" required>
                            ...
                            <div class="form-group">
                               ...
                               <div style="display: flex;margin-left:20px;"> <input disabled type="radio" class="form-control @if($errors->has('priority')) invalid-field @endif" id="priority" name="priority" style="width: 2% !important;" @if ($newcomer->priority==='normal') checked @endif value="normal"  required/><h6 style="margin-top:10px;margin-left:10px;">Normal</h6></div>
                               <div style="display: flex;margin-left:20px;"> <input disabled type="radio" class="form-control @if($errors->has('priority')) invalid-field @endif" id="priority" name="priority" style="width: 2% !important;" @if ($newcomer->priority==='priority') checked @endif value="priority"  required /><h6 style="margin-top:10px;margin-left:10px;">Priority</h6></div>
                        ...
                        <div class="kt-portlet__foot">
                            ...
                            <a href="{{route('NewComer.edit',$newcomer->id)}}"><button class="btn btn-primary">Edit</button></a> 
                             </div>
                        </div>
                </div>
        </div>
