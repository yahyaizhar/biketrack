...
@section('foot')
    ...
    <script>
        var lat, lng;
        loadCordinates(42.4668, -70.9495);
        ...
        function initMap(){
            ...
            var marker = new google.maps.Marker({
                ...
                // icon: "{{ asset('dashboard/assets/media/marker/bike-marker.png') }}"
            });
            var infoWindow = new google.maps.InfoWindow({
                content: "<h3>Rider Name</h3>"
            });
        ...
        function loadCordinates(latitude, longitude)
        {
            lat = latitude;
            lng = longitude;
        }
