...
class Company_Tax extends Authenticatable
{
    /**
     * Start logging.
     *
...
self::updating(function ($updated_model) {
    ...
    protected $fillable = [
        ...
        'log_in_hours_payable',
        'trips_payable',
        'amount_for_login_hours',
        'amount_to_be_paid_against_orders_completed',
        'total_to_be_paid_out_with_tax',
        'taxable_amount',
        'active_status',
    ];
}
