...
Route::group([
    ...
    Route::post("/delete/accounts/company/rows/{id}/{model_class}/{model_id}","AccountsController@delete_company_account_rows")->name("admin.delete_company_account_rows");
    Route::get("/delete/accounts/rider/rows/{id}","AccountsController@delete_rider_account_rows")->name("admin.delete_rider_account_rows");
