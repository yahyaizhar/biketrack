...
//import Zomato
    ...
    Route::get("/client/{cleint_id}/salarysheet","AccountsController@zomato_salary_sheet_export")->name("admin.zomato_salary_sheet_export");
...
// Client_income
    ...
    Route::get('/client_income/{client_id}/getRiders/month/{month}','AccountsController@client_income_getRiders')->name('admin.client_income_getRiders');
